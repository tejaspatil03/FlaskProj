...
import hashlib
# FIX: Using explicit imports from the internal 'PyJWT' structure to bypass local environment conflicts.
# The user's local 'jwt' module is missing 'encode' and 'decode'.
...
def login():
    ...
    if user and user['password'] == hash_password(password):
        ...
        # Generate JWT token - Use encode (imported directly)
